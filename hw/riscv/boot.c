...
target_ulong riscv_load_firmware(const char *filename)
{
    uint64_t firmware_entry, firmware_start, firmware_end;

    if (load_elf(filename, NULL, NULL, NULL,
...
target_ulong riscv_load_kernel(const char *filename, void *fdt)
{
    uint64_t kernel_entry, kernel_start, kernel_end;

    if (load_elf(filename, NULL, kernel_translate, NULL,
...
target_ulong riscv_load_firmware_kernel_initrd(MachineState *machine, void *fdt)
{
