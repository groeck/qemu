...
static void pfuze_class_init(ObjectClass *oc, const void *data)
{
...
static void pfuze100_class_init(ObjectClass *oc, const void *data)
{
...
static void pfuze200_class_init(ObjectClass *oc, const void *data)
{
    PFUZExxxClass *sc = PFUZE_CLASS(oc);
...
static void pfuze3000_class_init(ObjectClass *oc, const void *data)
{
    PFUZExxxClass *sc = PFUZE_CLASS(oc);
...
static void pfuze3001_class_init(ObjectClass *oc, const void *data)
{
    PFUZExxxClass *sc = PFUZE_CLASS(oc);
