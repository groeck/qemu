 ...
 * "STMP" dummy device
 *
 * This is a dummy device which follows "STMP" register layout.
...
static void stmp_write(void *opaque, hwaddr offset,
...
static Property stmp_properties[] = {
    DEFINE_PROP_UINT64("size", StmpDeviceState, size, 0),
