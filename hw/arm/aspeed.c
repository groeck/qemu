...
static void bonnell_bmc_i2c_init(AspeedMachineState *bmc)
{
    ...
    at24c_eeprom_init(bus, 0x51, 32 * KiB);
    /* tca9554@11:20 */
    ...
    at24c_eeprom_init(bus, 0x50, 32 * KiB);
    at24c_eeprom_init(bus, 0x51, 32 * KiB);
    ...
    /* Bonnell expects a TMP275 but a TMP105 is compatible */
    i2c_slave_create_simple(bus, TYPE_TMP105, 0x48);
    at24c_eeprom_init(bus, 0x51, 64 * KiB);
    ...
    at24c_eeprom_init(aspeed_i2c_get_bus(&soc->i2c, 12), 0x50, 64 * KiB);
