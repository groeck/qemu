...
static void allwinner_r40_realize(DeviceState *dev, Error **errp)
{
    ...
    if (machine_usb(current_machine)) {
        ...
        for (i = 0; i < AW_R40_NUM_USB; i++) {
            ...
            sysbus_mmio_map(SYS_BUS_DEVICE(&s->ehci[i]), 0,
                            allwinner_r40_memmap[i ? AW_R40_DEV_EHCI2 : AW_R40_DEV_EHCI1]);
            ...
            sysbus_mmio_map(SYS_BUS_DEVICE(&s->ohci[i]), 0,
                            allwinner_r40_memmap[i ? AW_R40_DEV_OHCI2 : AW_R40_DEV_OHCI1]);
    ...
    if (!machine_usb(current_machine)) {
        ...
        create_unimplemented_device("usb-ehci1", allwinner_r40_memmap[AW_R40_DEV_EHCI1], 0x800);
        create_unimplemented_device("usb-ehci2", allwinner_r40_memmap[AW_R40_DEV_EHCI2], 0x800);
        create_unimplemented_device("usb-ohci1", allwinner_r40_memmap[AW_R40_DEV_OHCI1], 0x800);
        create_unimplemented_device("usb-ohci2", allwinner_r40_memmap[AW_R40_DEV_OHCI2], 0x800);
    }
}
