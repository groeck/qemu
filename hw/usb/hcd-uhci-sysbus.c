...
static const Property uhci_sysbus_properties[] = {
...
static void uhci_sysbus_class_init(ObjectClass *klass, const void *data)
{
...
static void uhci_sysbus_aspeed_class_init(ObjectClass *klass, const void *data)
{
    DeviceClass *dc = DEVICE_CLASS(klass);
